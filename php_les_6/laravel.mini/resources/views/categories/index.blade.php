                    ...
                    @foreach($products as $product)
                        <!-- Product -->
                            ...
                            <div class="product">
                                ...
                                <div class="product_extra product_new"><a href="{{route('getCategory', $product->category['alias'])}}">{{$product->category['title']}}</a></div>
                                <div class="product_content">
                                    <div class="product_title">
                                        <a href="{{route('getProduct', ['category', $product->id])}}">
                                            {{$product->title}}
                                        </a>
                                    </div>
            ...
            $('.product_sorting_btn').click(function (){
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        $('.product_grid').imageslLoaded( function() {
